...
class STMatrix(object):
    ...
    onOffset method: dateOffset.onOffset(date).
        ...
        while i < len(self.pd_timestamps)-10:
            Flag = True
            ...
            x_c = [self.get_matrix(self.pd_timestamps[i- j]) for j in depends[0]]
            x_p = [self.get_matrix(self.pd_timestamps[i- j]) for j in depends[1]]
            x_t = [self.get_matrix(self.pd_timestamps[i- j]) for j in depends[2]]
