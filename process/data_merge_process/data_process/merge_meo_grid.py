...
def ProcessAqData():
    aq_grid_dict = {}
    aq_station_data = pd.read_csv("/home/fly/PycharmProjects/gmh/data_merge_process/data/Beijing_AirQuality_Stations_cn_data.csv")
    aq_grid_data = pd.read_csv("/home/fly/PycharmProjects/our_competition_project/KDD_air_pollution/data/process_data/grid_18_meo.csv")
    ...
    result_data.to_csv('/home/fly/PycharmProjects/our_competition_project/KDD_air_pollution/data/process_data/merge_grid_meo.csv',index=False)
    # del_row_index_list = []
