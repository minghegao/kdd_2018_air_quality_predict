...
def train_model(train_air='pm25'):
    ...
    pm25_data=pm25_data.ix[1:800000,:]
    ...
    EXT1 = ExtraTreesRegressor(n_jobs=-1, random_state=1, **best_params1,verbose=1)
    ...
    model_file='/home/fly/PycharmProjects/our_competition_project/KDD_air_pollution/data/save_model/extra_'+train_air+'.model'
    with open(model_file, 'wb') as fout:
        pickle.dump(EXT1, fout)
    #print(model_param)
